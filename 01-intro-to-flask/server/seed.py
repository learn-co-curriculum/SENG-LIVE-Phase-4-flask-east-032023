...
with app.app_context():
    ...
    # Delete all existing records from Production
    Production.query.delete()
    
    # Create some seeds for production and commit them to the database. 
    productions = []
    ...
    #add them to our DB session
    db.session.add_all(productions)
    #commit them to our db
    db.session.commit()
